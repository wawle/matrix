  ...
  nodes: [
    {
      ...
      data: {
        ...
        isActive: true,
        fields: [
          { id: "c1", name: "fullname", type: "string", required: true },
          { id: "c2", name: "email", type: "string", required: true },
          { id: "c3", name: "phone", type: "string", required: false },
          { id: "c4", name: "role", type: "string", required: true },
          { id: "c5", name: "password", type: "string", required: true },
        ],
      },
    },
    {
      ...
      data: {
        ...
        isActive: true,
        fields: [
          { id: "co1", name: "id", type: "string", required: true },
          { id: "co2", name: "name", type: "string", required: true },
          { id: "co3", name: "user", type: "reference", required: false },
        ],
      },
    },
    {
      ...
      data: {
        ...
        fields: [
          { id: "o1", name: "id", type: "string", required: true },
          { id: "o2", name: "title", type: "string", required: true },
          { id: "o3", name: "user", type: "reference", required: true },
          { id: "o4", name: "customer", type: "reference", required: true },
          { id: "o5", name: "status", type: "string", required: true },
          { id: "o6", name: "description", type: "string", required: false },
          { id: "o7", name: "date", type: "date", required: true },
          { id: "o8", name: "type", type: "string", required: true },
          { id: "o9", name: "priority", type: "string", required: true },
        ],
      },
    },
  ],
