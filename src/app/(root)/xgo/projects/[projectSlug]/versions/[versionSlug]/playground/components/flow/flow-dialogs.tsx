...
import { IAgentConnectionType, IAgentData } from "@/lib/types/xgo/agents";
...
interface FlowDialogsProps {
  ...
  setNewAgent: React.Dispatch<React.SetStateAction<Node<IAgentData>>>;
  onAddNewAgent: () => void;
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                value={newAgent.name}
                onChange={(e) =>
                  setNewAgent((prevAgent: Node<IAgentData>) => ({
                    ...prevAgent,
